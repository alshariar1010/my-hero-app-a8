  ...
  return (
    <div className="py-16 bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl font-bold mb-4 text-center">Your Installed Apps</h1>
        <p className="text-[#627382] mb-8 text-center">Explore All Trending Apps on the Market developed by us</p>
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
          <span className="text-[#001931] font-bold text-2xl">{installedApps.length} Apps Found</span>
          <select 
            value={sortOrder} 
            onChange={handleSort} 
